...
bool realign(BamAlignment& alignment, const std::string& ref_sequence, Alignment& new_alignment){
    ...
    new_alignment = Alignment(start_position, end_position, alignment.IsReverseStrand(), alignment.GetDeleted(), alignment.Name(), base_qualities, sequence, alignment_seq);
...
void convertAlignment(BamAlignment& alignment, const std::string& ref_sequence, Alignment& new_alignment){
  ...
  new_alignment = Alignment(alignment.Position(), alignment.GetEndPosition()-1, alignment.IsReverseStrand(), false, alignment.Name(), alignment.Qualities(), read_sequence, "");
